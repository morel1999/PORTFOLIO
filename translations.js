...
const translations = {
  fr: {
    ...
    'work.mrl.flip': 'Survolez pour en savoir plus',
    'work.mrl.desc': 'Blog technologique sur l\'IA, la cybersécurité, l\'innovation et les gadgets tech. Inclut des ressources et références utiles (GitHub, etc.).',
    'work.mrl.link': 'En développement →',
    'work.mohval.flip': 'Survolez pour en savoir plus',
    'work.mohval.desc': 'PWA de recherche intelligente d\'articles (vêtements, chaussures) avec IA personnalisée selon le budget, taille, couleur et préférences de l\'utilisateur.',
    'work.mohval.link': 'En développement →',
    'work.greenpy.flip': 'Survolez pour en savoir plus',
    'work.greenpy.desc': 'Plateforme web d\'apprentissage Python avec interface retro OS (style Windows 98). Un professeur IA propulsé par Groq corrige les exercices et accompagne l\'élève avec 39 leçons, système XP et gamification.',
    'work.greenpy.github': 'Voir sur GitHub',
  ...
  en: {
    ...
    'work.mrl.flip': 'Hover to learn more',
    'work.mrl.desc': 'Tech blog about AI, cybersecurity, innovation and tech gadgets. Includes useful resources and references (GitHub, etc.).',
    'work.mrl.link': 'In development →',
    'work.mohval.flip': 'Hover to learn more',
    'work.mohval.desc': 'Intelligent PWA for searching articles (clothing, shoes) with personalized AI based on budget, size, color and user preferences.',
    'work.mohval.link': 'In development →',
    'work.greenpy.flip': 'Hover to learn more',
    'work.greenpy.desc': 'Python learning web platform with retro OS interface (Windows 98 style). An AI teacher powered by Groq corrects exercises and guides the student with 39 lessons, XP system and gamification.',
    'work.greenpy.github': 'View on GitHub',
  ...
  tr: {
    ...
    'work.mrl.flip': 'Daha fazla bilgi için üzerine gelin',
    'work.mrl.desc': 'Yapay zeka, siber güvenlik, inovasyon ve teknoloji gadget\'ları hakkında teknoloji blogu. Faydalı kaynaklar ve referanslar (GitHub vb.) içerir.',
    'work.mrl.link': 'Geliştirme aşamasında →',
    'work.mohval.flip': 'Daha fazla bilgi için üzerine gelin',
    'work.mohval.desc': 'Bütçe, beden, renk ve kullanıcı tercihlerine göre kişiselleştirilmiş yapay zeka ile akıllı ürün arama PWA\'sı (giyim, ayakkabı).',
    'work.mohval.link': 'Geliştirme aşamasında →',
    'work.greenpy.flip': 'Daha fazla bilgi için üzerine gelin',
    'work.greenpy.desc': 'Retro işletim sistemi arayüzüne (Windows 98 tarzı) sahip Python öğrenme web platformu. Groq destekli yapay zeka öğretmen, 39 ders, XP sistemi ve oyunlaştırma ile öğrenciye eşlik eder.',
    'work.greenpy.github': 'GitHub\'da Görüntüle',
